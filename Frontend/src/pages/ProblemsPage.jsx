...
const ProblemsPage = () => {
  ...
  return (
    <div className="bg-slate-950 text-slate-100 min-h-screen overflow-hidden">
      ...
      {/* Stats Section */}
      <section className="border-y border-slate-800 bg-slate-900/50 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <h2 className="text-3xl font-bold text-center mb-12">Your Progress</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center p-6 bg-slate-800/30 rounded-xl border border-slate-700/50 hover:border-blue-500/50 transition-all">
              <div className="text-4xl font-bold text-blue-400 mb-2">
                {problems.length}
              </div>
              <div className="text-sm text-slate-400">Total Problems</div>
            </div>
            <AnimatedCounter label="Easy Problems" finalValue={difficultyStats.easy} />
            <AnimatedCounter label="Medium Problems" finalValue={difficultyStats.medium} />
            <AnimatedCounter label="Hard Problems" finalValue={difficultyStats.hard} />
          </div>
        </div>
      </section>
